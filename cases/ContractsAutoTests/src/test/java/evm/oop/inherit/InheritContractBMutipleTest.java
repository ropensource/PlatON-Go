...
import network.platon.contracts.InheritContractSubclass;
...
public class InheritContractBMutipleTest extends ContractPrepareTest {
    ...
    public void testInheritContractMutipleTest1() {
        ...
        try {
            //合约部署
            inheritContractSubclass = InheritContractSubclass.load("0xed8eb7434664b327e699fe8490aa6607eda9a850",web3j, transactionManager, provider);
