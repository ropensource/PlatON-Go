...
import network.platon.contracts.AbstractContractGSubclass;
...
public class AbstractContractDInhertTest extends ContractPrepareTest {
   ...
   private String age,resultAge;
    ...
    public void testAbstractContract() {
        ...
        try {
            //合约部署
            abstractContractGSubclass = AbstractContractGSubclass.load("0xf0bb6bcb615e160b287f58441816ee7d99a8e092",web3j, transactionManager, provider);
