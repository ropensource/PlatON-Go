...
import network.platon.contracts.BubbleSort;
...
public class BubbleSortTest extends ContractPrepareTest {
    ...
    public void test() {
        ...
        try {
            ...
            BubbleSort bubblesort = BubbleSort.load("0x372ef84a4f0c346a911ef330ae0ea5f328742838", web3j, transactionManager, provider);
